    ...
    private void SetIcon(MessageBoxIcon icon)
    {
        switch (icon)
        {
            case MessageBoxIcon.Error: //Error
                this.pictureBoxIcon.Image = ProjetoAvaliação.Properties.Resources.error;
            ...
            case MessageBoxIcon.Information: //Information
                this.pictureBoxIcon.Image = ProjetoAvaliação.Properties.Resources.information;
                PrimaryColor = Color.FromArgb(38, 191, 166);
                break;
            case MessageBoxIcon.Question://Question
                this.pictureBoxIcon.Image = ProjetoAvaliação.Properties.Resources.question;
                PrimaryColor = Color.FromArgb(10, 119, 232);
                break;
            case MessageBoxIcon.Exclamation://Exclamation
                this.pictureBoxIcon.Image = ProjetoAvaliação.Properties.Resources.exclamation;
                PrimaryColor = Color.FromArgb(255, 140, 0);
                break;
            case MessageBoxIcon.None: //None
                this.pictureBoxIcon.Image = ProjetoAvaliação.Properties.Resources.chat;
